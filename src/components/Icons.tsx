// Heroicons as inline SVG components for better control

export const PinIcon = ({ filled = false, className = "" }: { filled?: boolean; className?: string }) => (
  <svg
